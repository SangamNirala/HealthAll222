...
BACKEND_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://medreasonfix.preview.emergentagent.com')
...
# Backend URL from environment
BACKEND_URL = "https://medreasonfix.preview.emergentagent.com/api"
